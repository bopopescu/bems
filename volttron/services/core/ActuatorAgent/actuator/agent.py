...
class ActuatorAgent(Agent):
    ...
    :param driver_vip_identity: VIP identity of the Main Driver Agent. 
    ...
    def configure(self, config_name, action, contents):
        ...
        _log.debug("MainDriver VIP IDENTITY: {}".format(self.driver_vip_identity))
    ...
    def _heart_beat(self):
        ...
        try:
            ...
            _log.warning("Main driver is not running")
    ...
    def get_multiple_points(self, topics, **kwargs):
        ...
        RPC call to the main driver per device.
